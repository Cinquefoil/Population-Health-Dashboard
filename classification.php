            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav" style="font-size:12px">
                        ...
                        <li>
                            <a href="classification.php" style="background-color:#1AACBF;color:#FFF;border-bottom:2px #1AACBF solid"><span class="glyphicon glyphicon-heart" aria-hidden="true"></span> Health Classification</a>
                        </li>
						<li>
		...
		<script type="text/javascript">
			...
			********************************************************/
            ...
            d3.json(("js/ReturnResult.php"),function(error, data){
                ...
                var circleData = [
                    { "cx": 750, "cy": 300, "radius": 10, "color" : "#d62728", "action" : "Home Visit or Teleconsult" },
                    { "cx": 750, "cy": 330, "radius": 10, "color" : "#ff7f0e", "action" : "Teleconsult" },
                    { "cx": 750, "cy": 360, "radius": 10, "color" : "#2ca02c", "action" : "Intervention Programme" }];
