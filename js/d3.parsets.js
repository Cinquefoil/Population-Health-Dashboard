...
(function() {
  d3.parsets = function() {
    ...
    parsets.tooltipPS = function(_) {
      if (!arguments.length) return tooltipPS;
    ...
    var tooltipPS = body.append("div")
        .style("display", "none")
        .attr("class", "parsets tooltipPS");

    return d3.rebind(parsets, event, "on").value(1).width(900).height(400);
