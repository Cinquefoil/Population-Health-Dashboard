                ...
                <div id="msform">
                    ...
                    <fieldset>
                        ...
                        if ($FileValidation != 'File Validation Successful!') {
                            ?>
                            <div class="alert alert-danger" role="alert">Warning:<?php echo $FileValidation ?></div>
                    ...
                    <fieldset>
                        ...
                        if (!empty($_SESSION['GeoErrorReport'])) {
                            ...
                            ?>
                            <div class="alert alert-danger" role="alert">Warning:Fail to find the following location:
                                <?php
                                foreach ($GeoErrorReport as $PostalCodeGoogle) {
                                    echo $PostalCodeGoogle;
                                }
                                ?>
                            </div>
                            <?php
