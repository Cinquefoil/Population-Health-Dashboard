...
if($_SESSION['access'] == "senior"){
	header("location: home.php");
}
else if ($_SESSION['access'] == "operation"){
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li>                        
                            <a href="fileUploadUI.php" style="background-color:#1AACBF;color:#FFF;border-bottom:2px #1AACBF solid"><span class="glyphicon glyphicon-upload" style="padding:0px" aria-hidden="true"></span>Data Processing</a>
                        </li>
                        <li>
            ...
            if (empty($_SESSION['response'])) {
                ...
                <div id="msform">
                    ...
                    <fieldset>
                        ...
                        if($response != 'Successfully loaded to database!'){
                        ?>
                            <div class="alert alert-danger" role="alert">Warning:<?php echo $response ?></div>
                            <?php  unset($_SESSION['response']); ?>
                            <a href="fileUploadUI.php" class="btn btn-success" role="button">File Upload</a>
                        <?php  
                        }else{
                        ?>
                            <h2 class="fs-title">File Validation</h2>
                            <div class="alert alert-success" role="alert">You have uploaded an excel file!</div>
                    ...
                    <fieldset>
                        ...
                        <div class="alert alert-success" role="alert">Your data has been successfully transformed for Geo Coding!</div>
                        <input type="button" name="previous" class="previous action-button" value="Previous" />
                        <input type="button" name="next" class="next action-button" value="Next" />
                    </fieldset>
                    <fieldset>
                        <h2 class="fs-title">Geo Coding</h2>
                        <div class="alert alert-success" role="alert">Geo Code has been generated successfully!</div>
                        <input type="button" name="previous" class="previous action-button" value="Previous" />
                        <input type="button" name="next" class="next action-button" value="Next" />
                    </fieldset>
                    <fieldset>
